...
func (tp *testPlugin) Execute(ctx context.Context, data []byte, msg func(entities.PluginMessage) error) error {
	return nil
}
...
func TestCommunicate(t *testing.T) {
	...
	c := NewConnector("http://some.url/", "test-key", plugins, mkGetLndAPI(&cli.Context{}))
